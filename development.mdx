---
title: 'Development'
description: 'Preview changes locally before deploying'
---
...
Follow these steps to install and run Mintlify on your operating system. The CLI provides a local preview so you can see changes before deploying.
